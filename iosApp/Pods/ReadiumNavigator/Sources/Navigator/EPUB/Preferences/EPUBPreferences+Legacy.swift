...
public extension EPUBPreferences {
    ...
    static func fromLegacyPreferences(
        ...
        return EPUBPreferences(
            ...
            .flatMap {
                (columnCountValues ?? defaultColumnCountValues).getOrNil($0)
            }
            .flatMap {
                ColumnCount(rawValue: $0)
            },
            ...
            .flatMap {
                (fontFamilyValues ?? defaultFontFamilyValues).getOrNil($0)
            }
            .map {
                FontFamily(rawValue: $0)
            },
            ...
            .flatMap {
                (textAlignmentValues ?? defaultTextAlignmentValues).getOrNil($0)
            }
            .flatMap {
                TextAlignment(rawValue: $0)
            },
            ...
            .flatMap {
                (appearanceValues ?? defaultAppearanceValues).getOrNil($0)
            }
            .flatMap {
                switch $0 {
