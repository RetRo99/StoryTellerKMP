...
public extension VisualNavigator {
    ...
    var readingProgression: ReadiumShared.ReadingProgression {
        fatalError()
    }
}
...
public extension VisualNavigator {
    ...
    @available(*, unavailable, message: "Use the async variant")
    func goLeft(animated: Bool = false, completion: @escaping () -> Void = {
    }) -> Bool {
        fatalError()
    }

    @available(*, unavailable, message: "Use the async variant")
    func goRight(animated: Bool = false, completion: @escaping () -> Void = {
    }) -> Bool {
        fatalError()
    }
}
