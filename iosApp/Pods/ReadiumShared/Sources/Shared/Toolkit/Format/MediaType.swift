...
public struct MediaType: Hashable, Loggable, Sendable {
    ...
    public func contains(_ other: Self?) -> Bool {
        ...
        let paramsSet = Set(parameters.map {
            "\($0.key)=\($0.value)"
        })
        let otherParamsSet = Set(other.parameters.map {
            "\($0.key)=\($0.value)"
        })
    ...
    public static let flac = MediaType("audio/flac")!
    ...
    public static let mp4 = MediaType("audio/mp4")!
    public static let mpegAudio = MediaType("audio/mpeg")!
    public static let mpegVideo = MediaType("video/mpeg")!
