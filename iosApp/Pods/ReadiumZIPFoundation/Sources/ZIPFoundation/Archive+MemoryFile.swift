...
extension Archive {
    var isMemoryArchive: Bool {
        return self.url.scheme == memoryURLScheme
    }
}
...
private func readStub(_ cookie: UnsafeMutableRawPointer?,
                      ...
                      _ count: Int32) -> Int32 {
    guard let cookie = cookie, let bytePtr = bytePtr else {
        return 0
    }
...
private func seekStub(_ cookie: UnsafeMutableRawPointer?,
    ...
    guard let cookie = cookie, let offset = offset else {
        return 0
    }
