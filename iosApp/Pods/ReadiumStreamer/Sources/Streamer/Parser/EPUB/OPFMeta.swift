...
struct OPFMetaList {
    ...
    private func isRWPMProperty(_ meta: OPFMeta) -> Bool {
        let vocabularyProperties = (rwpmProperties.first {
            $0.key.uri == meta.vocabularyURI
        })?
        .value ?? []
