...
public class TokeniserStateVars {
    ...
    static let attributeSingleValueChars = Set(["'", UnicodeScalar.Ampersand, nullScalr].flatMap {
        $0.utf8
    })
    static let attributeDoubleValueChars = Set(["\"", UnicodeScalar.Ampersand, nullScalr].flatMap {
        $0.utf8
    })
    static let attributeNameChars = Set([UnicodeScalar.BackslashT, "\n", "\r", UnicodeScalar.BackslashF, " ", "/", "=", ">", nullScalr, "\"", "'", UnicodeScalar.LessThan].flatMap {
        $0.utf8
    })
    static let attributeValueUnquoted = Set([UnicodeScalar.BackslashT, "\n", "\r", UnicodeScalar.BackslashF, " ", UnicodeScalar.Ampersand, ">", nullScalr, "\"", "'", UnicodeScalar.LessThan, "=", "`"].flatMap {
        $0.utf8
    })

    static let dataDefaultStopChars = Set([UnicodeScalar.Ampersand, UnicodeScalar.LessThan, TokeniserStateVars.nullScalr].flatMap {
        $0.utf8
    })
    static let scriptDataDefaultStopChars = Set(["-", UnicodeScalar.LessThan, TokeniserStateVars.nullScalr].flatMap {
        $0.utf8
    })
    static let commentDefaultStopChars = Set(["-", TokeniserStateVars.nullScalr].flatMap {
        $0.utf8
    })
    static let readDataDefaultStopChars = Set([UnicodeScalar.LessThan, TokeniserStateVars.nullScalr].flatMap {
        $0.utf8
    })
