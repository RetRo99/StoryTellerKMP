 ...
 * (like [Analytics], [SmilParser], and [SmilQuickScanner]). The [create] method accepts
 * runtime dependencies that are only available when the navigator fragment is ready.
 *
